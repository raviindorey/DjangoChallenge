...
For functional tests we have installed `selenium` and `webdrivermanager`

```python
  from webdrivermanager import GeckoDriverManager # For Firefox
  from webdrivermanager import ChromeDriverManager # For Chrome
